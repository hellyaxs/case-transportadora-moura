...
Define the repository convention that technical code, contracts, database schema, and machine-readable identifiers use English naming while product documentation may remain in Portuguese.
