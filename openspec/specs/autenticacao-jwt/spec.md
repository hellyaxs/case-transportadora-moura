...
Definir autenticação operacional por e-mail e senha, mantendo a sessão JWT exclusivamente em cookie HttpOnly emitido pela API para proteger endpoints operacionais.
